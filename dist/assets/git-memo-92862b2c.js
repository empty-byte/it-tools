import{o as s,e as n,a2 as l,d as i,a3 as m,i as p,g as o,a4 as g,B as d}from"./index-02ffc62f.js";const h={class:"markdown-body"},u={__name:"git-memo.content",setup(c,{expose:e}){return e({frontmatter:{}}),(r,t)=>(s(),n("div",h,t[0]||(t[0]=[l(`<h2>Configuration</h2><p>Set the global config</p><pre><code class="language-shell">git config --global user.name &quot;[name]&quot;
...
</code></pre>`,27)])))}},_=i({__name:"git-memo",setup(c){g(a=>({"2f6ba480":o(e).cardColor}));const e=m();return(a,r)=>(s(),n("div",null,[p(o(u))]))}});const b=d(_,[["__scopeId","data-v-3f9f904a"]]);export{b as default};
